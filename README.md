...
### 步骤3: 修改Spring配置
提供了两种生成器: [DefaultUidGenerator](src/main/java/com/jero/snowflake/impl/DefaultUidGenerator.java)、[CachedUidGenerator](src/main/java/com/jero/snowflake/impl/CachedUidGenerator.java)。如对UID生成性能有要求, 请使用CachedUidGenerator<br/>
...
```xml
<!-- DefaultUidGenerator -->
<bean id="defaultUidGenerator" class="com.jero.snowflake.impl.DefaultUidGenerator" lazy-init="false">
...
```xml
<!-- CachedUidGenerator -->
<bean id="cachedUidGenerator" class="com.jero.snowflake.impl.CachedUidGenerator">
    <property name="workerIdAssigner" ref="disposableWorkerIdAssigner" />
...
<!-- 用完即弃的WorkerIdAssigner, 依赖DB操作 -->
<bean id="disposableWorkerIdAssigner" class="com.jero.snowflake.worker.DefaultWorkerIdAssigner" />
